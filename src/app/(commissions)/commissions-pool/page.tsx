  ...
  >
    ...
    <div className="flex flex-col flex-grow min-w-0">
      ...
      <div className="flex items-center gap-2 mt-auto pt-4">
        <span className="px-2.5 py-1 bg-neutral-50 border border-neutral-200 text-xs font-semibold text-neutral-600 rounded-md flex items-center gap-1.5">
          <Hash className="w-3.5 h-3.5" /> Quantity: {request.quantity}
        </span>
      </div>
    </div>
    ...
    <div className="flex flex-col sm:items-end justify-between shrink-0 sm:min-w-[160px] mt-3 sm:mt-0 pt-4 sm:pt-0 border-t sm:border-t-0 border-neutral-100">
      <div className="text-left sm:text-right">
        <p className="text-xs font-medium text-neutral-500 mb-1">Budget Range</p>
    ...
    >
      ...
      >
        ...
        <div className="lg:w-1/2 overflow-y-auto bg-white snap-y">
          ...
          {/* Details Content */}
          <div className="p-8 lg:-mt-16 lg:relative z-10 lg:bg-white lg:rounded-t-3xl border-t border-neutral-100">
            {/* Meta Row */}
            ...
            <div className="mt-4 p-4 rounded-xl bg-green-50 border border-green-100 inline-block w-full sm:w-auto">
               <p className="text-xs font-semibold text-green-700 mb-1 uppercase tracking-wider">Client's Budget Range</p>
          ...
          {isOwner ? (
            <div className="flex flex-col items-center justify-center flex-1 text-center py-12">
              ...
              <p className="text-sm text-neutral-500 max-w-[280px] mb-8 leading-relaxed">
                You are currently viewing a request you created. You cannot send a quotation to yourself.
              </p>
              {canCancel ? (
                <button
            ...
            <>
              ...
              <div className="mb-8">
                ...
                <p className="text-sm text-neutral-500 mt-2 leading-relaxed">
                  ...
                  you will use to build this custom keyboard.
                </p>
              </div>
              ...
              >
                ...
                <div>
                  <label className="block text-sm font-semibold text-neutral-900 mb-2">
                    Estimated Time to Build <span className="text-red-500">*</span>
                  </label>
                  <select
                    value={estimatedDays}
                ...
                <div className="flex-1 flex flex-col">
                  <div className="flex justify-between items-end mb-2">
                    <label className="block text-sm font-semibold text-neutral-900">
                      Build Plan & Materials <span className="text-red-500">*</span>
                    </label>
                    <span className="text-xs text-neutral-400">Min 10 chars</span>
                  </div>
                  <textarea
                    value={note}
                    onChange={(e) => setNote(e.target.value)}
                    rows={6}
                    placeholder="Describe in detail the switches, keycaps, and mods you will use...&#10;E.g.: Gateron Oil King lubed, GMK Olivia clones, full foam kit, tempest tape mod..."
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            ...
            <p className="text-neutral-500 mt-2 text-sm max-w-xl leading-relaxed">
              Browse <span className="font-semibold text-neutral-700">{poolRequests.length}</span> active requests from buyers looking for custom keyboard builds. Quote your price and win the contract.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto shrink-0">
            ...
            >
              <Store className="w-4 h-4 text-neutral-400" /> Direct Request
            </button>
            <button
        ...
        {!loadingPool && !error && poolRequests.length === 0 && (
          <div className="flex flex-col items-center justify-center py-24 text-center border border-dashed border-neutral-200 bg-white rounded-2xl shadow-sm mt-4">
            ...
            <p className="text-sm text-neutral-500 max-w-md leading-relaxed">
              ...
              market. Please check back later or start a new request.
            </p>
          </div>
        )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-[2px] p-4 sm:p-6" onClick={() => setIsShopSelectionOpen(false)}>
          <div className="bg-white w-full max-w-md rounded-xl p-6 shadow-2xl flex flex-col max-h-[85vh] animate-in zoom-in-95 duration-200" onClick={e => e.stopPropagation()}>
            <div className="flex justify-between items-center mb-5 border-b border-neutral-100 pb-4">
              <h3 className="text-lg font-semibold text-neutral-900">Select a Builder</h3>
            ...
            <div className="overflow-y-auto space-y-3 flex-1 pr-1 custom-scrollbar">
              {shopList.length === 0 ? (
                <div className="py-12 flex flex-col items-center justify-center text-center">
                  ...
                  <span className="text-neutral-500 text-sm font-medium">Loading builders...</span>
                </div>
              ) : (
                shopList.map(shop => (
                  <div
