...
export default function CancelRequestDetailPage() {
    ...
    return (
      <div className="bg-neutral-50 min-h-[calc(100vh-4rem)] p-4 md:p-8 font-sans">
        <div className="max-w-2xl mx-auto text-center py-20 bg-white border border-neutral-100 rounded-2xl shadow-sm">
          ...
          <h2 className="text-xl font-semibold text-neutral-900 mb-2">{t("notFoundTitle")}</h2>
          <p className="text-sm text-neutral-500 mb-8">{t("notFoundDesc")}</p>
          <button 
            onClick={() => router.back()}
  ...
  return (
    <div className="bg-neutral-50 min-h-[calc(100vh-4rem)] p-4 md:p-2 text-neutral-900 font-sans w-full">
      <div className="max-w-3xl mx-auto py-4">
        <button
          onClick={() => router.back()}
          className="flex items-center gap-2 text-neutral-500 hover:text-neutral-900 transition-colors mb-2 group w-fit"
        >
          ...
          <span className="text-sm font-medium">{t("backToRequests")}</span>
        </button>
        ...
        <div className="bg-white border border-neutral-100 shadow-sm rounded-2xl flex flex-col overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 p-6 border-b border-neutral-50 bg-white">
            <div>
              <span className="text-neutral-500 text-xs font-semibold uppercase tracking-wider block mb-2">{t("orderId")}</span>
            ...
            <div className="flex flex-col items-start md:items-end gap-3 w-full md:w-auto">
              <div className="flex w-full md:w-auto justify-between md:justify-end items-center gap-4">
                 <span className="text-xs font-semibold text-neutral-500 uppercase tracking-widest md:hidden">{t("statusLabel")}</span>
          ...
          <div className="p-6">
            <span className="text-neutral-500 text-xs font-semibold uppercase tracking-wider block mb-4">{t("reason")}</span>
