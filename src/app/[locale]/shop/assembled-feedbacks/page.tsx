    ...
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
          ...
          Quản lý Đánh giá SP Lắp Ráp
        </h1>
        <p className="text-gray-500 mt-1">
          Xem và phản hồi các đánh giá từ khách hàng về các sản phẩm lắp ráp của bạn.
        </p>
      </div>
                ...
                >
                  <td className="p-4 align-top">
                    ...
                    <div className="text-xs text-gray-500 flex items-center gap-1 mt-1 truncate max-w-[200px]" title={item.assembledProductId}>
                      ...
                      SP: {item.assembledProductId.substring(0, 8)}...
                    </div>
                  </td>
                  <td className="p-4 align-top">
                  ...
                  <td colSpan={4} className="p-12 text-center">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <p className="text-gray-400 font-medium">
                        Chưa có đánh giá nào cho sản phẩm lắp ráp.
                      </p>
                    </div>
                  </td>
                </tr>
