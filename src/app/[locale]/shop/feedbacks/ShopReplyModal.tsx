...
export default function ShopReplyModal({
  isOpen,
  onClose,
  feedbackId,
  onSuccess,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await feedbackService.replyToFeedback(feedbackId, reply);
