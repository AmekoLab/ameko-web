...
const BenefitBar: FC = () => (
  <div className="w-full bg-[#0d0f12]  py-5 ">
    <div className="max-w-[1920px] mx-auto px-6 lg:px-12 flex flex-col xl:flex-row justify-between items-center gap-8">
      ...
      <div className="flex flex-col items-center xl:items-start text-center xl:text-left shrink-0">
        <h3 className="text-white font-light text-xl lg:text-3xl uppercase tracking-wider leading-snug">
          WHY BUY DIRECT
          <br />
          FROM AMEKO?
        </h3>
        <Link
          href="/about"
          className="text-[#f5d800] text-[11px] font-bold uppercase tracking-widest hover:text-white transition-colors flex items-center gap-1 mt-2"
        >
        ...
        {defaultTrustBadges.map((badge, i) => {
          ...
          return (
            <div key={i} className="flex items-center gap-3">
              <div className="w-11 h-11 rounded-full bg-[#23262b] flex items-center justify-center shrink-0">
...
export const PromoGridSection: FC<PromoGridSectionProps> = ({
  ...
  return (
    <section className="w-full bg-[#0d0f12]">
      {/* [A] Benefit Bar */}
      <BenefitBar />
        ...
        >
          ...
          <div className="relative overflow-hidden group min-h-[480px] lg:min-h-[700px]">
            ...
            <div className="absolute bottom-0 left-0 p-7 lg:p-10">
              ...
              <p className="text-sm text-gray-300 mt-1 leading-snug max-w-sm">
                {heroCard.subtitle}
              </p>
              <Link
                href={heroCard.ctaHref}
                className="inline-flex items-center gap-1 mt-4 text-[#f5d800] hover:text-white text-[11px] font-bold uppercase tracking-widest transition-colors"
              >
          ...
          <div className="flex flex-col" style={{ gap: "14px" }}>
            {promoCards.map((card, i) => (
              ...
              >
                ...
                <div className="w-[45%] bg-[#202030] flex flex-col justify-start p-4 lg:p-6 shrink-0">
                  <h3 className="text-base lg:text-lg font-black uppercase text-white tracking-wider leading-tight">
                    {card.title}
                  </h3>
                  <p className="text-xs lg:text-sm text-gray-400 leading-relaxed mt-2 lg:mt-3">
                    {card.description}
                  </p>
                  <Link
                    href={card.ctaHref}
                    className="inline-flex items-center gap-1 mt-5 lg:mt-7 text-[#f5d800] hover:text-white text-[11px] font-bold uppercase tracking-widest transition-colors"
                  >
